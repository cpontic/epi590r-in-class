...
The mean and IQR of the number of dogs at the shelter are there because of Owner Surrender is `r inline_text(table1, column = "Total", row = "Canine relinquished by owner")`.
...
As you can see in @tbl2, both confidence intervals are significant with Canine_starting_animal_count of `r inline_text(tbl2, column = 95% CI, row = 'Canine_starting_animal_count')` and Canine returned to owner of `r inline_text(tbl2, column = 95% CI, row = 'Canine_reterned_to_owner')`.
