...
As you can see in @tbl2, both confidence intervals are significant with Canine_starting_animal_count of `r gtsummary::inline_text(tbl2, variable = "Canine_starting_animal_count")` and Canine returned to owner of `r gtsummary::inline_text(tbl2, variable = "Canine_returned_to_owner")`. 
