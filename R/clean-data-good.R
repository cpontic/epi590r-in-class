...
#always start at the top and go down***** do this often
...
nlsy <- read_csv(here::here("data", "raw", "nlsy.csv"), ##here::here prints out file path were the docs are automatically
				 na = c("-1", "-2", "-3", "-4", "-5", "-998"),
...
#we could also create a new folder in file browser or in the files on the right
